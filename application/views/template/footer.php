   ...
   <script>
     ...
     // Bar Chart Example 2
     var ctx = document.getElementById("surat_keluar");
     var surat_keluar = new Chart(ctx, {
       type: 'bar',
       data: {
         labels: ["Januari", "Februari", "Maret", "April", "Mai", "Juni", "juli", "Agustus", "Septembera", "Oktober", "November", "Desember"],
         datasets: [{
           ...
           borderColor: "#4e73df",
           //  data statik
           data: [<?= $kbulan1 ?>, <?= $kbulan2 ?>, <?= $kbulan3 ?>, <?= $kbulan4 ?>, <?= $kbulan5 ?>, <?= $kbulan6 ?>, <?= $kbulan7 ?>, <?= $kbulan8 ?>, <?= $kbulan9 ?>, <?= $kbulan10 ?>, <?= $kbulan11 ?>, <?= $kbulan12 ?>],
         }],
       },
       options: {
         maintainAspectRatio: false,
